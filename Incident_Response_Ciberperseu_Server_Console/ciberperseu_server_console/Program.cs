...
namespace ciberperseu_server_console
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Ciberperseu Folder
            if (!Directory.Exists("C:/Ciberperseu"))
            {
                Directory.CreateDirectory("C:/Ciberperseu");
                XML_FileCreation("C:/Ciberperseu/MS03.xml");
                XML_FileCreation("C:/Ciberperseu/MS04.xml");
                XML_FileCreation("C:/Ciberperseu/MS05.xml");
                XML_FileCreation("C:/Ciberperseu/MS07.xml");
                XML_FileCreation("C:/Ciberperseu/MS_Geral.xml");
                XML_FileCreation("C:/Ciberperseu/Accounts.xml");
                XML_FileCreation("C:/Ciberperseu/Logs.xml");
                XML_FileCreation("C:/Ciberperseu/Mails.xml");
                File.CreateText("C:/Ciberperseu/chat.txt").Close();
                File.CreateText("C:/Ciberperseu/chat_index.txt").Close();

                FileStream chat_index = File.OpenWrite("C:/Ciberperseu/chat_index.txt");
                ...
                xml_doc = XDocument.Load("C:/Ciberperseu/Accounts.xml");
                ...
                xml_doc.Save("C:/Ciberperseu/Accounts.xml");
            }
    ...
    public class handleClient
    {
        ...
        private void connection()
        {
            ...
            servercertificate = new X509Certificate2("C:/ciberperseu_cert.pfx", "ciberperseu");
            ...
            try
            {
                ...
                xmlDoc.Load("C:/Ciberperseu/Accounts.xml");
                ...
                log_xml = XDocument.Load("C:/Ciberperseu/Logs.xml");
                ...
                log_xml.Save("C:/Ciberperseu/Logs.xml");
                ...
                while (true)
                {
                    ...
                    switch (MessageData)
                    {
                        ...
                        // Missons Mails Send
                        case ("MS03_XML<EOF>"):
                            XML_SEND("C:/Ciberperseu/MS03.xml", sslStream);
                            break;
                        case ("MS04_XML<EOF>"):
                            XML_SEND("C:/Ciberperseu/MS04.xml", sslStream);
                            break;
                        case ("MS05_XML<EOF>"):
                            XML_SEND("C:/Ciberperseu/MS05.xml", sslStream);
                            break;
                        case ("MS07_XML<EOF>"):
                            XML_SEND("C:/Ciberperseu/MS07.xml", sslStream);
                            break;
                        ...
                        case ("MS_GERAL<EOF>"):
                            XML_Geral_SEND("C:/Ciberperseu/MS_Geral.xml", sslStream);
                            break;
        ...
        {
            XDocument xml_doc = new XDocument();
            xml_doc = XDocument.Load("C:/Ciberperseu/" + missaoXML);
            ...
            xml_doc.Save("C:/Ciberperseu/" + missaoXML);
        }
        ...
        {
            XmlDocument xmlDoc = new XmlDocument();
            xmlDoc.Load("C:/Ciberperseu/" + missaoXML);
            XmlElement root = xmlDoc.DocumentElement;
            XmlNodeList node_list = root.SelectNodes("ID");
            ...
            xmlDoc.Save("C:/Ciberperseu/" + missaoXML);
        }
        ...
        {
            XDocument xml_doc = new XDocument();
            xml_doc = XDocument.Load("C:/Ciberperseu/" + xmlGeral);
            xml_doc.Element("root").Add(new XElement("ID", ID.Substring(0, (ID.Length - 5)),
            ...
            xml_doc.Save("C:/Ciberperseu/" + xmlGeral);
        }
        ...
        {
            XmlDocument xmlDoc = new XmlDocument();
            xmlDoc.Load("C:/Ciberperseu/" + xmlGeral);
            XmlElement root = xmlDoc.DocumentElement;
            XmlNodeList node_list = root.SelectNodes("ID");
            ...
            xmlDoc.Save("C:/Ciberperseu/" + xmlGeral);
        }
        ...
        private void Perfil(SslStream sslStream)
        {
            ...
            xmlDoc.Save("C:/Ciberperseu/Accounts.xml");
        ...
        private void Logs(SslStream sslStream)
        {
            byte[] message;
            XmlDocument xmlDoc = new XmlDocument();
            xmlDoc.Load("C:/Ciberperseu/Logs.xml");
            XmlElement root = xmlDoc.DocumentElement;
        ...
        private void Mail_Read(SslStream sslStream)
        {
            ...
            XmlDocument xmlDoc = new XmlDocument();
            xmlDoc.Load("C:/Ciberperseu/Mails.xml");
            XmlElement root = xmlDoc.DocumentElement;
        ...
        private void Mail_Remove(SslStream sslStream)
        {
            ...
            foreach (XmlNode node in node_list)
            {
                ...
                {
                    root.RemoveChild(node_list.Item(i));
                    xmlDoc.Save("C:/Ciberperseu/Mails.xml");
                    break;
                }
        ...
        {
            XmlDocument xmlDoc = new XmlDocument();
            xmlDoc.Load("C:/Ciberperseu/MS_Geral.xml");
            XmlElement root = xmlDoc.DocumentElement;
            XmlNodeList node_list = root.SelectNodes("ID");
            ...
            xmlDoc.Save("C:/Ciberperseu/MS_Geral.xml");
        }

        private void Chat_request(SslStream sslStream)
        {
            byte[] message;
            using (StreamReader sr = File.OpenText("C:/Ciberperseu/chat.txt"))
            {
                string s = "";
        ...
        {
            StreamReader sr = File.OpenText("C:/Ciberperseu/chat_index.txt");
            string chat_message;
            ...
            count += 1;
            FileStream index_file = File.OpenWrite("C:/Ciberperseu/chat_index.txt");
            ...
            using (StreamWriter chat_writer = File.AppendText("C:/Ciberperseu/chat.txt"))
            {
        ...
        {
            FileStream chat_index = File.OpenRead("C:/Ciberperseu/chat_index.txt");
        ...
        {
            StreamWriter chat_text = new StreamWriter("C:/Ciberperseu/chat.txt");
            chat_text.Write("");
            chat_text.Close();

            StreamWriter chat_index_new = new StreamWriter("C:/Ciberperseu/chat_index.txt");
