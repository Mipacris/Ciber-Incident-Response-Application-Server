...
namespace cyber_server_console
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Cyber Server Folder
            if (!Directory.Exists("C:/Cyber_Server_Data"))
            {
                Directory.CreateDirectory("C:/Cyber_Server_Data");
                XML_FileCreation("C:/Cyber_Server_Data/MS03.xml");
                XML_FileCreation("C:/Cyber_Server_Data/MS04.xml");
                XML_FileCreation("C:/Cyber_Server_Data/MS05.xml");
                XML_FileCreation("C:/Cyber_Server_Data/MS07.xml");
                XML_FileCreation("C:/Cyber_Server_Data/MS_Geral.xml");
                XML_FileCreation("C:/Cyber_Server_Data/Accounts.xml");
                XML_FileCreation("C:/Cyber_Server_Data/Logs.xml");
                XML_FileCreation("C:/Cyber_Server_Data/Mails.xml");
                File.CreateText("C:/Cyber_Server_Data/chat.txt").Close();
                File.CreateText("C:/Cyber_Server_Data/chat_index.txt").Close();

                FileStream chat_index = File.OpenWrite("C:/Cyber_Server_Data/chat_index.txt");
                ...
                xml_doc = XDocument.Load("C:/Cyber_Server_Data/Accounts.xml");
                ...
                xml_doc.Save("C:/Cyber_Server_Data/Accounts.xml");
            }
    ...
    public class handleClient
    {
        ...
        private void connection()
        {
            ...
            servercertificate = new X509Certificate2("C:/cyber_cert.pfx", "cyber");
            ...
            try
            {
                ...
                xmlDoc.Load("C:/Cyber_Server_Data/Accounts.xml");
                ...
                log_xml = XDocument.Load("C:/Cyber_Server_Data/Logs.xml");
                ...
                log_xml.Save("C:/Cyber_Server_Data/Logs.xml");
                ...
                while (true)
                {
                    ...
                    switch (MessageData)
                    {
                        ...
                        // Missons Mails Send
                        case ("MS03_XML<EOF>"):
                            XML_SEND("C:/Cyber_Server_Data/MS03.xml", sslStream);
                            break;
                        case ("MS04_XML<EOF>"):
                            XML_SEND("C:/Cyber_Server_Data/MS04.xml", sslStream);
                            break;
                        case ("MS05_XML<EOF>"):
                            XML_SEND("C:/Cyber_Server_Data/MS05.xml", sslStream);
                            break;
                        case ("MS07_XML<EOF>"):
                            XML_SEND("C:/Cyber_Server_Data/MS07.xml", sslStream);
                            break;
                        ...
                        case ("MS_GERAL<EOF>"):
                            XML_Geral_SEND("C:/Cyber_Server_Data/MS_Geral.xml", sslStream);
                            break;
        ...
        {
            XDocument xml_doc = new XDocument();
            xml_doc = XDocument.Load("C:/Cyber_Server_Data/" + missaoXML);
            ...
            xml_doc.Save("C:/Cyber_Server_Data/" + missaoXML);
        }
        ...
        {
            XmlDocument xmlDoc = new XmlDocument();
            xmlDoc.Load("C:/Cyber_Server_Data/" + missaoXML);
            XmlElement root = xmlDoc.DocumentElement;
            XmlNodeList node_list = root.SelectNodes("ID");
            ...
            xmlDoc.Save("C:/Cyber_Server_Data/" + missaoXML);
        }
        ...
        {
            XDocument xml_doc = new XDocument();
            xml_doc = XDocument.Load("C:/Cyber_Server_Data/" + xmlGeral);
            xml_doc.Element("root").Add(new XElement("ID", ID.Substring(0, (ID.Length - 5)),
            ...
            xml_doc.Save("C:/Cyber_Server_Data/" + xmlGeral);
        }
        ...
        {
            XmlDocument xmlDoc = new XmlDocument();
            xmlDoc.Load("C:/Cyber_Server_Data/" + xmlGeral);
            XmlElement root = xmlDoc.DocumentElement;
            XmlNodeList node_list = root.SelectNodes("ID");
            ...
            xmlDoc.Save("C:/Cyber_Server_Data/" + xmlGeral);
        }
        ...
        private void Perfil(SslStream sslStream)
        {
            ...
            xmlDoc.Save("C:/Cyber_Server_Data/Accounts.xml");
        ...
        private void Logs(SslStream sslStream)
        {
            byte[] message;
            XmlDocument xmlDoc = new XmlDocument();
            xmlDoc.Load("C:/Cyber_Server_Data/Logs.xml");
            XmlElement root = xmlDoc.DocumentElement;
        ...
        private void Mail_Add(SslStream sslStream)
        {
            ...
            XDocument xml_doc = new XDocument();
            xml_doc = XDocument.Load("C:/Cyber_Server_Data/Mails.xml");
            xml_doc.Element("root").Add(new XElement("Mails", "",
                new XElement("mail", mail.Substring(0, (mail.Length - 5)))));
            xml_doc.Save("C:/Cyber_Server_Data/Mails.xml");
        }
        ...
        private void Mail_Read(SslStream sslStream)
        {
            ...
            XmlDocument xmlDoc = new XmlDocument();
            xmlDoc.Load("C:/Cyber_Server_Data/Mails.xml");
            XmlElement root = xmlDoc.DocumentElement;
        ...
        private void Mail_Remove(SslStream sslStream)
        {
            ...
            foreach (XmlNode node in node_list)
            {
                ...
                {
                    root.RemoveChild(node_list.Item(i));
                    xmlDoc.Save("C:/Cyber_Server_Data/Mails.xml");
                    break;
                }
        ...
        {
            XmlDocument xmlDoc = new XmlDocument();
            xmlDoc.Load("C:/Cyber_Server_Data/MS_Geral.xml");
            XmlElement root = xmlDoc.DocumentElement;
            XmlNodeList node_list = root.SelectNodes("ID");
            ...
            xmlDoc.Save("C:/Cyber_Server_Data/MS_Geral.xml");
        }

        private void Chat_request(SslStream sslStream)
        {
            byte[] message;
            using (StreamReader sr = File.OpenText("C:/Cyber_Server_Data/chat.txt"))
            {
                string s = "";
        ...
        {
            StreamReader sr = File.OpenText("C:/Cyber_Server_Data/chat_index.txt");
            string chat_message;
            ...
            count += 1;
            FileStream index_file = File.OpenWrite("C:/Cyber_Server_Data/chat_index.txt");
            ...
            using (StreamWriter chat_writer = File.AppendText("C:/Cyber_Server_Data/chat.txt"))
            {
        ...
        {
            FileStream chat_index = File.OpenRead("C:/Cyber_Server_Data/chat_index.txt");
        ...
        {
            StreamWriter chat_text = new StreamWriter("C:/Cyber_Server_Data/chat.txt");
            chat_text.Write("");
            chat_text.Close();

            StreamWriter chat_index_new = new StreamWriter("C:/Cyber_Server_Data/chat_index.txt");
