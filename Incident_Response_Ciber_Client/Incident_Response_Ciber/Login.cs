...
namespace Incident_Response_Ciber
{
    public partial class Login : Form
    {
        ...
        public Login()
        {
            ...
            if (Directory.Exists("C:/Ciber_Save_Data"))
            {
                StreamReader ip_port_file = new StreamReader("C:/Ciber_Save_Data/login_ip_port_registry.txt");
                int count = 0;
                string line;
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (!Directory.Exists("C:/Ciber_Save_Data"))
            {
                Directory.CreateDirectory("C:/Ciber_Save_Data");
                var file_create = File.Create("C:/Ciber_Save_Data/login_ip_port_registry.txt");
                file_create.Close();

                File.CreateText("C:/Ciber_Save_Data/chat_index.txt").Close();
                StreamWriter chat_index = new StreamWriter("C:/Ciber_Save_Data/chat_index.txt");
            ...
            {
                File.WriteAllText("C:/Ciber_Save_Data/login_ip_port_registry.txt", String.Empty);
                file = new StreamWriter("C:/Ciber_Save_Data/login_ip_port_registry.txt");
            ...
            try
            {
                ...
                sslstream.AuthenticateAsClient("ciber");
